...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lcom/motorola/camera/Camera$$ExternalSyntheticLambda11;-><init>(Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;)V
...
.method public static synthetic updateUiForSplitScreen$default(Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;ZI)V
    .locals 0
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 12
    sget-object v4, Lcom/motorola/camera/storage/MediaFile$Companion;->$$INSTANCE:Lcom/motorola/camera/storage/MediaFile$Companion;

    invoke-virtual {v4, v3}, Lcom/motorola/camera/storage/MediaFile$Companion;->fromMemento(Lcom/motorola/camera/storage/MediaFile$Memento;)Lcom/motorola/camera/storage/MediaFile;
    ...
    const-string v12, "com.motorola.superslowmotion.intent.videoFrameRate"
    ...
    const-string v13, "com.motorola.superslowmotion.intent.slowDownRate"
    ...
    .line 18
    new-instance v1, Lcom/motorola/camera/superslowmotion/SuperSlowMotionData;
    ...
    sget v4, Lcom/motorola/camera/databinding/SuperSlowMotionActivityBinding;->$r8$clinit:I
    ...
    .line 21
    invoke-static {v3, v4, v5, v2, v5}, Landroidx/databinding/ViewDataBinding;->inflateInternal(Landroid/view/LayoutInflater;ILandroid/view/ViewGroup;ZLjava/lang/Object;)Landroidx/databinding/ViewDataBinding;

    move-result-object v3

    check-cast v3, Lcom/motorola/camera/databinding/SuperSlowMotionActivityBinding;

    const-string v4, "inflate(LayoutInflater.from(this))"

    .line 22
    invoke-static {v3, v4}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    iput-object v3, v0, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;->viewBinding:Lcom/motorola/camera/databinding/SuperSlowMotionActivityBinding;

    .line 23
    new-instance v3, Lcom/motorola/camera/superslowmotion/SuperSlowMotionViewModel$Factory;

    invoke-direct {v3, v0, v1}, Lcom/motorola/camera/superslowmotion/SuperSlowMotionViewModel$Factory;-><init>(Landroid/content/Context;Lcom/motorola/camera/superslowmotion/SuperSlowMotionData;)V
    ...
    .line 28
    iget-object v7, v1, Landroidx/lifecycle/ViewModelStore;->mMap:Ljava/util/HashMap;
    ...
    .line 30
    instance-of v1, v3, Landroidx/lifecycle/ViewModelProvider$OnRequeryFactory;
    ...
    invoke-virtual {v3, v7}, Landroidx/lifecycle/ViewModelProvider$OnRequeryFactory;->onRequery(Landroidx/lifecycle/ViewModel;)V

    goto :goto_1

    .line 32
    :cond_0
    instance-of v7, v3, Landroidx/lifecycle/ViewModelProvider$KeyedFactory;

    if-eqz v7, :cond_1

    .line 33
    check-cast v3, Landroidx/lifecycle/ViewModelProvider$KeyedFactory;

    invoke-virtual {v3, v6, v4}, Landroidx/lifecycle/ViewModelProvider$KeyedFactory;->create(Ljava/lang/String;Ljava/lang/Class;)Landroidx/lifecycle/ViewModel;
    ...
    .line 34
    :cond_1
    invoke-virtual {v3, v4}, Lcom/motorola/camera/superslowmotion/SuperSlowMotionViewModel$Factory;->create(Ljava/lang/Class;)Landroidx/lifecycle/ViewModel;
    ...
    check-cast v7, Lcom/motorola/camera/superslowmotion/SuperSlowMotionViewModel;

    .line 38
    iput-object v7, v0, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;->viewModel:Lcom/motorola/camera/superslowmotion/SuperSlowMotionViewModel;
    ...
    invoke-virtual {v1, v7}, Lcom/motorola/camera/databinding/SuperSlowMotionActivityBinding;->setViewModel(Lcom/motorola/camera/superslowmotion/SuperSlowMotionViewModel;)V
    ...
    iget-object v1, v1, Lcom/motorola/camera/databinding/SuperSlowMotionActivityBinding;->superSlowMotionPlayer:Lcom/google/android/exoplayer2/ui/PlayerView;
    ...
    .line 46
    iget-object v4, v4, Lcom/motorola/camera/superslowmotion/SuperSlowMotionController;->exoPlayer:Lcom/google/android/exoplayer2/ExoPlayer;

    .line 47
    invoke-virtual {v1, v4}, Lcom/google/android/exoplayer2/ui/PlayerView;->setPlayer(Lcom/google/android/exoplayer2/Player;)V
    ...
    invoke-direct {v4, v0}, Lcom/google/android/exoplayer2/ExoPlayerImpl$$ExternalSyntheticLambda13;-><init>(Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;)V
    ...
    invoke-direct {v4, v0}, Lcom/motorola/camera/Camera$$ExternalSyntheticLambda8;-><init>(Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;)V
    ...
    .line 60
    :cond_3
    invoke-virtual {v1}, Lcom/motorola/camera/superslowmotion/SuperSlowMotionEditTooltip;->update()V

    goto :goto_2

    .line 61
    :cond_4
    new-instance v4, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity$onCreate$$inlined$doOnLayout$1;

    invoke-direct {v4, v0}, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity$onCreate$$inlined$doOnLayout$1;-><init>(Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;)V
    ...
    .line 64
    new-instance v4, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity$onCreate$$inlined$observe$1;

    invoke-direct {v4, v0}, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity$onCreate$$inlined$observe$1;-><init>(Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;)V
    ...
    .line 67
    iget-object v1, v1, Lcom/motorola/camera/superslowmotion/SuperSlowMotionViewModel;->processingDone:Landroidx/lifecycle/LiveData;

    .line 68
    new-instance v4, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity$onCreate$$inlined$observe$2;

    invoke-direct {v4, v0}, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity$onCreate$$inlined$observe$2;-><init>(Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;)V
    ...
    .line 71
    iget-object v1, v1, Lcom/motorola/camera/superslowmotion/SuperSlowMotionViewModel;->processingError:Landroidx/lifecycle/LiveData;

    .line 72
    new-instance v4, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity$onCreate$$inlined$observe$3;

    invoke-direct {v4, v0}, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity$onCreate$$inlined$observe$3;-><init>(Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;)V
    ...
    .line 75
    iget-object v1, v1, Lcom/motorola/camera/superslowmotion/SuperSlowMotionViewModel;->editControlsVisible:Landroidx/lifecycle/LiveData;

    .line 76
    new-instance v4, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity$onCreate$$inlined$observe$4;

    invoke-direct {v4, v0}, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity$onCreate$$inlined$observe$4;-><init>(Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;)V
    ...
    new-instance v4, Lcom/motorola/camera/editor/DocEditorActivity$$ExternalSyntheticLambda4;

    invoke-direct {v4, v0}, Lcom/motorola/camera/editor/DocEditorActivity$$ExternalSyntheticLambda4;-><init>(Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;)V
    ...
    invoke-direct {v4, v0}, Lcom/motorola/camera/cinemagraph/CinemagraphMaskActivity$$ExternalSyntheticLambda1;-><init>(Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;)V
    ...
    const-string/jumbo v4, "viewBinding.root"
    ...
    .line 86
    :cond_5
    new-instance v4, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity$onCreate$$inlined$doOnLayout$2;

    invoke-direct {v4, v0}, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity$onCreate$$inlined$doOnLayout$2;-><init>(Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;)V
    ...
    .line 90
    sget-object v1, Lcom/motorola/camera/settings/SettingsManager;->DEBUG_FOLDABLE_SPLIT_SCREEN_DEV_MODE:Lcom/motorola/camera/settings/SettingsManager$Key;
    ...
    const-string v4, "get(SettingsManager.DEBU\u2026IT_SCREEN_DEV_MODE).value"
    ...
    iget-object v1, v1, Lcom/motorola/camera/databinding/SuperSlowMotionActivityBinding;->superSlowMotionSplitScreenToggle:Landroid/widget/ToggleButton;
    ...
    invoke-direct {v2, v0}, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity$$ExternalSyntheticLambda3;-><init>(Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;)V
    ...
    :cond_8
    :goto_4
    iget-object v1, v0, Landroidx/activity/ComponentActivity;->mLifecycleRegistry:Landroidx/lifecycle/LifecycleRegistry;
    ...
    .line 100
    :cond_9
    iget-object v2, v1, Landroidx/lifecycle/Lifecycle;->mInternalScopeRef:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v4, v5}, Lkotlinx/coroutines/SupervisorJobImpl;-><init>(Lkotlinx/coroutines/Job;)V

    .line 103
    sget-object v6, Lkotlinx/coroutines/Dispatchers;->Default:Lkotlinx/coroutines/CoroutineDispatcher;
    ...
    .line 106
    invoke-static {v4, v7}, Lkotlin/coroutines/CoroutineContext$Element$DefaultImpls;->plus(Lkotlin/coroutines/CoroutineContext$Element;Lkotlin/coroutines/CoroutineContext;)Lkotlin/coroutines/CoroutineContext;

    move-result-object v4

    .line 107
    invoke-direct {v2, v1, v4}, Landroidx/lifecycle/LifecycleCoroutineScopeImpl;-><init>(Landroidx/lifecycle/Lifecycle;Lkotlin/coroutines/CoroutineContext;)V

    .line 108
    iget-object v4, v1, Landroidx/lifecycle/Lifecycle;->mInternalScopeRef:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    new-instance v9, Landroidx/lifecycle/LifecycleCoroutineScopeImpl$register$1;

    invoke-direct {v9, v2, v5}, Landroidx/lifecycle/LifecycleCoroutineScopeImpl$register$1;-><init>(Landroidx/lifecycle/LifecycleCoroutineScopeImpl;Lkotlin/coroutines/Continuation;)V
    ...
    .line 111
    sget-object v13, Lkotlinx/coroutines/internal/MainDispatcherLoader;->dispatcher:Lkotlinx/coroutines/MainCoroutineDispatcher;

    .line 112
    new-instance v15, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity$onCreate$15;

    invoke-direct {v15, v0, v5}, Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity$onCreate$15;-><init>(Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;Lkotlin/coroutines/Continuation;)V
...
.method public final showSkipDialog()V
    ...
    invoke-direct {v2, p0}, Lcom/motorola/camera/editor/DocEditorActivity$$ExternalSyntheticLambda0;-><init>(Lcom/motorola/camera/superslowmotion/SuperSlowMotionActivity;)V
