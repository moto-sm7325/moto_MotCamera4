...
.method public final adjustLayoutToRealScreenSize()V
    ...
    .line 1
    invoke-static {p0}, Lcom/google/mlkit/vision/barcode/zza;->getRealSize(Landroid/app/Activity;)Landroid/graphics/Point;
...
.method public final launchGoogleLens()V
    ...
    invoke-direct {v2, p0, v0}, Lcom/motorola/camera/Camera$$ExternalSyntheticLambda7;-><init>(Lcom/motorola/camera/Camera;I)V

    invoke-virtual {v1, p0, v2}, Lcom/google/lens/sdk/LensApi;->launchLensActivity(Landroid/app/Activity;Lcom/google/lens/sdk/LensApi$LensLaunchStatusCallback;)V
    :try_end_0
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 19
    sget-object v2, Lcom/motorola/camera/storage/StorageUtils;->deleteTemporaryFilesCoroutine:Lkotlinx/coroutines/Job;
    ...
    sget-object v7, Lcom/motorola/camera/storage/StorageUtils$$ExternalSyntheticLambda0;->INSTANCE:Lcom/motorola/camera/storage/StorageUtils$$ExternalSyntheticLambda0;

    invoke-virtual {v2, v7}, Ljava/io/File;->listFiles(Ljava/io/FileFilter;)[Ljava/io/File;

    move-result-object v2

    sput-object v2, Lcom/motorola/camera/storage/StorageUtils;->tempFilesList:[Ljava/io/File;
    ...
    new-instance v8, Lcom/motorola/camera/ui/widgets/gl/ShaderCache$$ExternalSyntheticLambda1;

    invoke-direct {v8, v2}, Lcom/motorola/camera/ui/widgets/gl/ShaderCache$$ExternalSyntheticLambda1;-><init>(Lcom/motorola/camera/ui/widgets/gl/ShaderCache;)V

    const-string v2, "ShaderCache"

    invoke-direct {v7, v8, v2}, Ljava/lang/Thread;-><init>(Ljava/lang/Runnable;Ljava/lang/String;)V
    ...
    const-string v8, "setDisablePreviewScreenshots"
    ...
    iput-boolean v8, v7, Lcom/motorola/camera/CameraApp;->mMonkeyUser:Z
    ...
    invoke-virtual {v7, v8, v4}, Lcom/google/android/exoplayer2/FormatHolder;->putBoolean(Ljava/lang/String;Z)V

    .line 32
    iput-boolean v4, p0, Lcom/motorola/camera/Camera;->mIsColdStart:Z

    const-string v7, "com.motorola.camera3"
    ...
    invoke-virtual {v8, v7}, Landroid/content/pm/PackageManager;->hasSystemFeature(Ljava/lang/String;)Z
    ...
    .line 35
    invoke-virtual {v7, v8}, Lcom/motorola/camera/CameraApp;->showToast(I)V
    ...
    .line 42
    sget-object v8, Lcom/motorola/camera/AppFeatures$Feature;->POP_UP_FRONT_CAMERA:Lcom/motorola/camera/AppFeatures$Feature;
    ...
    new-array v9, v8, [Lcom/motorola/camera/CameraKpi$KPI;
    ...
    invoke-virtual {v7, v5, v6, v9}, Lcom/motorola/camera/CameraKpi;->startKpiRecord(J[Lcom/motorola/camera/CameraKpi$KPI;)V
    ...
    new-array v11, v11, [Lcom/motorola/camera/CameraKpi$KPI;
    ...
    sget-object v8, Lcom/motorola/camera/CameraKpi$KPI;->UI_SHOW:Lcom/motorola/camera/CameraKpi$KPI;
    ...
    invoke-virtual {v10, v5, v6, v11}, Lcom/motorola/camera/CameraKpi;->startKpiRecord(J[Lcom/motorola/camera/CameraKpi$KPI;)V
    ...
    .line 70
    invoke-virtual {v6, v8, v5, v3}, Lcom/motorola/camera/CameraApp;->setScreenParameters(Landroid/graphics/Point;Landroid/graphics/Point;I)V
    ...
    .line 73
    :try_start_1
    iput-boolean v2, v3, Lcom/motorola/camera/CameraApp;->mGestureNavInit:Z
    ...
    invoke-direct {v0, p0, v2, p0}, Lcom/motorola/camera/Controller;-><init>(Landroid/app/Activity;Landroid/view/ViewGroup;Lcom/motorola/camera/Controller$ActivityCallbackInterface;)V
...
.method public onDestroy()V
    ...
    invoke-direct {v2, v0}, Lcom/motorola/camera/Camera$$ExternalSyntheticLambda8;-><init>(Lcom/motorola/camera/Controller;)V
...
.method public onNewIntent(Landroid/content/Intent;)V
    ...
    .line 21
    :cond_6
    iget-boolean v1, v0, Lcom/motorola/camera/Controller;->mModeChanging:Z
    ...
    invoke-virtual {v0}, Lcom/motorola/camera/Controller;->getCallingPackage()Ljava/lang/String;

    move-result-object v2

    invoke-direct {v1, p1, v2}, Lcom/motorola/camera/settings/CaptureIntent;-><init>(Landroid/content/Intent;Ljava/lang/String;)V

    invoke-virtual {v1}, Lcom/motorola/camera/settings/CaptureIntent;->getMatchingMode()I
...
.method public onResumeTasks()V
    ...
    const-string v3, "App version: 90001272"
...
.method public onStart()V
    ...
    .line 104
    :cond_19
    iput-boolean v4, v1, Lcom/motorola/camera/Controller;->mModeChanging:Z
...
.method public final updateSplashPreview(Z)V
    ...
    invoke-direct/range {v2 .. v7}, Lcom/motorola/camera/Camera$$ExternalSyntheticLambda12;-><init>(Lcom/motorola/camera/Camera;Landroid/graphics/Bitmap;III)V
    ...
    invoke-direct {v0, p1}, Lcom/motorola/camera/Camera$$ExternalSyntheticLambda8;-><init>(Landroid/widget/ImageView;)V
