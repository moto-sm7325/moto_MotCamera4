...
.field public final mWindowInfoListener:Landroidx/core/util/Consumer;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/motorola/camera/Camera;->mWindowInfoListener:Landroidx/core/util/Consumer;
...
.method public final adjustLayoutToRealScreenSize()V
    ...
    invoke-static {p0, v0}, Landroidx/fragment/R$anim;->getRealSizeWithDecor(Landroid/app/Activity;Z)Landroid/graphics/Point;
...
.method public killApps()V
    ...
    .line 12
    :try_start_1
    iget-object v7, v0, Lcom/motorola/camera/reflect/android/app/IActivityManager;->mIActivityManager:Ljava/lang/Object;
    ...
    .line 23
    iget-object v5, v5, Lcom/motorola/camera/CameraApp;->mAnalytics:Lcom/motorola/camera/analytics/AnalyticsHelper;

    .line 24
    iget-object v7, v5, Lcom/motorola/camera/analytics/AnalyticsHelper;->mSessionValues:Lcom/google/android/gms/common/api/internal/zaz;

    const-string v8, "COLD"

    invoke-virtual {v7, v8}, Lcom/google/android/gms/common/api/internal/zaz;->getBoolean(Ljava/lang/String;)Z
    ...
    .line 25
    invoke-virtual {v7, v8}, Lcom/google/android/gms/common/api/internal/zaz;->containsKey(Ljava/lang/String;)Z
    ...
    invoke-virtual {v7, v8, v4}, Lcom/google/android/gms/common/api/internal/zaz;->putBoolean(Ljava/lang/String;Z)V
    ...
    const-string v9, "RAMAVL"

    invoke-virtual {v7, v9, v8}, Lcom/google/android/gms/common/api/internal/zaz;->putInt(Ljava/lang/String;I)V

    .line 28
    iget-object v5, v5, Lcom/motorola/camera/analytics/AnalyticsHelper;->mSessionValues:Lcom/google/android/gms/common/api/internal/zaz;
    ...
    invoke-virtual {v5, v7, v3}, Lcom/google/android/gms/common/api/internal/zaz;->putInt(Ljava/lang/String;I)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 20
    invoke-static/range {p0 .. p0}, Landroidx/fragment/R$anim;->getMainDisplayRealSize(Landroid/content/Context;)Landroid/graphics/Point;

    move-result-object v8

    invoke-static {v8, v3}, Lcom/motorola/camera/utility/ColdStartHelper;->onActivityCreate(Landroid/graphics/Point;Z)V

    .line 21
    sget-object v8, Lcom/motorola/camera/storage/StorageUtils;->deleteTemporaryFilesCoroutine:Lkotlinx/coroutines/Job;

    check-cast v8, Lkotlinx/coroutines/JobSupport;

    invoke-virtual {v8}, Lkotlinx/coroutines/JobSupport;->isCompleted()Z
    ...
    sget-object v9, Lcom/motorola/camera/storage/StorageUtils$$ExternalSyntheticLambda0;->INSTANCE:Lcom/motorola/camera/storage/StorageUtils$$ExternalSyntheticLambda0;

    invoke-virtual {v8, v9}, Ljava/io/File;->listFiles(Ljava/io/FileFilter;)[Ljava/io/File;

    move-result-object v8

    sput-object v8, Lcom/motorola/camera/storage/StorageUtils;->tempFilesList:[Ljava/io/File;
    ...
    invoke-virtual {v8}, Lkotlinx/coroutines/JobSupport;->start()Z
    ...
    new-instance v10, Lcom/motorola/camera/utility/ColdStartHelper$$ExternalSyntheticLambda0;

    invoke-direct {v10, v8}, Lcom/motorola/camera/utility/ColdStartHelper$$ExternalSyntheticLambda0;-><init>(Lcom/motorola/camera/ui/widgets/gl/ShaderCache;)V
    ...
    const-string v10, "setDisablePreviewScreenshots"
    ...
    iput-boolean v10, v9, Lcom/motorola/camera/CameraApp;->mMonkeyUser:Z
    ...
    .line 33
    iget-object v9, v9, Lcom/motorola/camera/analytics/AnalyticsHelper;->mSessionValues:Lcom/google/android/gms/common/api/internal/zaz;

    const-string v10, "COLD"

    invoke-virtual {v9, v10, v5}, Lcom/google/android/gms/common/api/internal/zaz;->putBoolean(Ljava/lang/String;Z)V
    ...
    .line 43
    iget-object v11, v9, Lcom/motorola/camera/AppFeatures;->mSupportedFeatureSet:Ljava/util/EnumSet;

    invoke-virtual {v11, v10}, Ljava/util/EnumSet;->contains(Ljava/lang/Object;)Z
    ...
    new-array v12, v11, [Lcom/motorola/camera/CameraKpi$KPI;
    ...
    invoke-virtual {v10, v6, v7, v12}, Lcom/motorola/camera/CameraKpi;->startKpiRecord(J[Lcom/motorola/camera/CameraKpi$KPI;)V
    ...
    new-array v14, v14, [Lcom/motorola/camera/CameraKpi$KPI;

    aput-object v2, v14, v8

    sget-object v15, Lcom/motorola/camera/CameraKpi$KPI;->START_TO_HAL_OPEN:Lcom/motorola/camera/CameraKpi$KPI;

    aput-object v15, v14, v5

    sget-object v15, Lcom/motorola/camera/CameraKpi$KPI;->TOTAL_STARTUP_W_CAF_O:Lcom/motorola/camera/CameraKpi$KPI;

    aput-object v15, v14, v11

    sget-object v11, Lcom/motorola/camera/CameraKpi$KPI;->UI_SHOW:Lcom/motorola/camera/CameraKpi$KPI;
    ...
    invoke-virtual {v13, v6, v7, v14}, Lcom/motorola/camera/CameraKpi;->startKpiRecord(J[Lcom/motorola/camera/CameraKpi$KPI;)V
    ...
    .line 68
    invoke-static {v0, v3}, Landroidx/fragment/R$anim;->getRealSizeWithDecor(Landroid/app/Activity;Z)Landroid/graphics/Point;
    ...
    .line 70
    invoke-virtual {v11, v13, v7, v4}, Lcom/motorola/camera/CameraApp;->setScreenParameters(Landroid/graphics/Point;Landroid/graphics/Point;I)V
    ...
    invoke-static {v4, v1}, Lcom/motorola/camera/Camera$$ExternalSyntheticOutline2;->m(Ljava/util/HashMap;Lcom/motorola/camera/CameraKpi$KPI;)V
    ...
    invoke-virtual {v4, v1}, Lcom/motorola/camera/CameraKpi;->endKpiRecord(Lcom/motorola/camera/CameraKpi$KPI;)J
    ...
    invoke-direct {v1, v0, v4, v0}, Lcom/motorola/camera/Controller;-><init>(Landroid/app/Activity;Landroid/view/ViewGroup;Lcom/motorola/camera/Controller$ActivityCallbackInterface;)V
    ...
    .line 84
    iget-object v4, v9, Lcom/motorola/camera/AppFeatures;->mSupportedFeatureSet:Ljava/util/EnumSet;
    ...
    .line 87
    sget-object v4, Landroidx/window/layout/WindowInfoTracker;->Companion:Landroidx/window/layout/WindowInfoTracker$Companion;

    invoke-virtual {v4, v0}, Landroidx/window/layout/WindowInfoTracker$Companion;->getOrCreate(Landroid/content/Context;)Landroidx/window/layout/WindowInfoTracker;

    move-result-object v4

    .line 88
    invoke-direct {v1, v4}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;-><init>(Landroidx/window/layout/WindowInfoTracker;)V
    ...
    iget-object v7, v0, Lcom/motorola/camera/Camera;->mWindowInfoListener:Landroidx/core/util/Consumer;

    invoke-virtual {v1, v0, v4, v7}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->addWindowLayoutInfoListener(Landroid/app/Activity;Ljava/util/concurrent/Executor;Landroidx/core/util/Consumer;)V
    ...
    .line 92
    iput v12, v1, Landroid/view/WindowManager$LayoutParams;->layoutInDisplayCutoutMode:I
    ...
    .line 96
    invoke-static {v0, v5}, Landroidx/core/view/MotionEventCompat;->showOnLockScreen(Landroid/app/Activity;Z)V
    ...
    .line 101
    invoke-virtual {v4, v3, v8}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v3, v4, v5, v8}, Lcom/motorola/camera/Controller;->checkIntent(Landroid/content/Intent;ZZ)V
    ...
    .line 109
    invoke-virtual {v0, v3, v4}, Landroid/app/Activity;->sendBroadcast(Landroid/content/Intent;Ljava/lang/String;)V

    .line 110
    new-instance v3, Lcom/motorola/camera/Camera$$ExternalSyntheticLambda12;

    invoke-direct {v3, v0, v1}, Lcom/motorola/camera/Camera$$ExternalSyntheticLambda12;-><init>(Lcom/motorola/camera/Camera;Z)V
...
.method public onDestroy()V
    ...
    invoke-direct {v2, v0}, Lcom/motorola/camera/Camera$$ExternalSyntheticLambda9;-><init>(Lcom/motorola/camera/Controller;)V
    ...
    invoke-direct {v6, v4, v1, v3}, Landroidx/room/QueryInterceptorDatabase$$ExternalSyntheticLambda1;-><init>(Lcom/motorola/camera/fsm/camera/CameraFsm;Lcom/motorola/camera/fsm/camera/StateChangeListener;Ljava/util/Collection;)V
...
.method public onNewIntent(Landroid/content/Intent;)V
    ...
    invoke-virtual {p1, p0, v1, v1, v2}, Lcom/motorola/camera/launch/LaunchManager;->launch(Landroid/app/Activity;ZII)V
...
.method public onPauseTasks()V
    ...
    .line 17
    iget-object v2, p0, Lcom/motorola/camera/Camera;->mDebugControlReceiver:Lcom/motorola/camera/DebugControlReceiver;

    invoke-virtual {p0, v2}, Landroid/app/Activity;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V

    .line 18
    :cond_4
    iget-object v2, p0, Lcom/motorola/camera/Camera;->mFeatureLimiterListener:Lcom/motorola/camera/limitfunctionality/FeatureLimiter$FeatureLimiterListener;
    ...
    .line 20
    invoke-virtual {v2}, Lcom/motorola/camera/CameraApp;->clearScreenBoundElementsSizes()V
    ...
    iget-object v3, p0, Lcom/motorola/camera/Camera;->mActivityForegroundReceiver:Landroid/content/BroadcastReceiver;
...
.method public onResumeTasks()V
    ...
    const-string v3, "App version: 90002884"
...
.method public onStart()V
    ...
    .line 11
    invoke-static {p0, v2}, Landroidx/core/view/MotionEventCompat;->showOnLockScreen(Landroid/app/Activity;Z)V
    ...
    iget-object v6, p0, Lcom/motorola/camera/Camera;->mWindowInfoListener:Landroidx/core/util/Consumer;

    invoke-virtual {v1, p0, v5, v6}, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->addWindowLayoutInfoListener(Landroid/app/Activity;Ljava/util/concurrent/Executor;Landroidx/core/util/Consumer;)V
    ...
    .line 42
    iget-object v1, v1, Lcom/motorola/camera/analytics/AnalyticsHelper;->mSessionValues:Lcom/google/android/gms/common/api/internal/zaz;
    ...
    .line 44
    invoke-virtual {v1, v6, v5}, Lcom/google/android/gms/common/api/internal/zaz;->putString(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v6, v7, v8}, Lcom/motorola/camera/shared/OrientationEvent;-><init>(Landroid/content/Context;Z)V
    ...
    new-instance v6, Lcom/motorola/camera/Controller$$ExternalSyntheticLambda7;

    invoke-direct {v6, v1, v4}, Lcom/motorola/camera/Controller$$ExternalSyntheticLambda7;-><init>(Lcom/motorola/camera/Controller;I)V
    ...
    new-instance v6, Lcom/motorola/camera/Controller$$ExternalSyntheticLambda9;

    invoke-direct {v6, v1}, Lcom/motorola/camera/Controller$$ExternalSyntheticLambda9;-><init>(Lcom/motorola/camera/Controller;)V
...
.method public onStop()V
    ...
    .line 25
    iget-object v4, p0, Lcom/motorola/camera/Camera;->mWindowInfoListener:Landroidx/core/util/Consumer;
    ...
    .line 27
    iget-object v5, v0, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->lock:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-interface {v5}, Ljava/util/concurrent/locks/Lock;->lock()V

    .line 28
    :try_start_0
    iget-object v6, v0, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->consumerToJobMap:Ljava/util/Map;
    ...
    .line 30
    :goto_1
    iget-object v0, v0, Landroidx/window/java/layout/WindowInfoTrackerCallbackAdapter;->consumerToJobMap:Ljava/util/Map;
    ...
    .line 71
    invoke-virtual {v1}, Lcom/motorola/camera/cli/content/CliContentManager;->finishContentActivity()V
    ...
    .line 91
    invoke-static {}, Lcom/motorola/camera/env/SettingsGlobal;->resetTransitionAnimationScaleValue()V
...
.method public onTopResumedActivityChanged(Z)V
    ...
    .line 3
    iput-boolean v1, v0, Lcom/motorola/camera/CameraApp;->mIsActivityOnTop:Z
...
.method public restartStateMachineAndInitOnResume()V
    ...
    const-string v1, "SKIP_FSM_REINIT"
...
.method public startActivity(Lcom/motorola/camera/Util$ActivityLaunchRequestInfo;)V
    ...
    .line 23
    :goto_0
    iget-object v7, v7, Lcom/motorola/camera/analytics/AnalyticsHelper;->mSessionValues:Lcom/google/android/gms/common/api/internal/zaz;
    ...
    .line 25
    invoke-virtual {v7, v9, v8}, Lcom/google/android/gms/common/api/internal/zaz;->putSerializable(Ljava/lang/String;Ljava/io/Serializable;)V
    ...
    :cond_6
    invoke-virtual {v1, v0, v13}, Lcom/google/lens/sdk/LensApi;->launchLensActivity(Landroid/app/Activity;I)V
    ...
    sget-object v10, Lcom/motorola/camera/Util$ActivityLaunchRequestInfo$LAUNCH_REQUEST_CODE;->DND_PERMISSION_REQUEST:Lcom/motorola/camera/Util$ActivityLaunchRequestInfo$LAUNCH_REQUEST_CODE;

    if-eq v7, v10, :cond_16

    sget-object v10, Lcom/motorola/camera/Util$ActivityLaunchRequestInfo$LAUNCH_REQUEST_CODE;->YOUTUBE_LIVE:Lcom/motorola/camera/Util$ActivityLaunchRequestInfo$LAUNCH_REQUEST_CODE;
    ...
    .line 83
    :cond_17
    iput-boolean v13, v0, Lcom/motorola/camera/Camera;->mKeepSessionSettingOnExit:Z
    ...
    .line 93
    invoke-static {v3, v4, v6, v7, v10}, Landroid/app/ActivityOptions;->makeClipRevealAnimation(Landroid/view/View;IIII)Landroid/app/ActivityOptions;
...
.method public final updateSplashPreview(ZZ)V
    ...
    .line 2
    iget-object v0, v0, Lcom/motorola/camera/Controller;->mLayoutManager:Lcom/motorola/camera/ui/layoutmanager/ILayoutManager;
    ...
    sget-object v3, Lcom/motorola/camera/background/provider/filedatacontract/FileUtils;->Companion:Lcom/motorola/camera/background/provider/filedatacontract/FileUtils$Companion;

    .line 18
    invoke-virtual {v3, p0}, Lcom/motorola/camera/background/provider/filedatacontract/FileUtils$Companion;->getSplashPathFile(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/motorola/camera/Camera$$ExternalSyntheticLambda13;-><init>(Lcom/motorola/camera/Camera;Landroid/graphics/Bitmap;III)V
