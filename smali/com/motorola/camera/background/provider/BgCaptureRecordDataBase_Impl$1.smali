.class public Lcom/motorola/camera/background/provider/BgCaptureRecordDataBase_Impl$1;
...
# direct methods
.method public constructor <init>(Lcom/motorola/camera/background/provider/BgCaptureRecordDataBase_Impl;I)V
    .locals 0
...
.method public createAllTables(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string p0, "CREATE TABLE IF NOT EXISTS `bgCaptureRecord_table` (`id` INTEGER NOT NULL, `mediaStoreUri` TEXT NOT NULL, `ts` INTEGER NOT NULL, `expirationTime` INTEGER NOT NULL, `clientId` INTEGER NOT NULL, `sourceId` INTEGER NOT NULL, `targetId` INTEGER NOT NULL, `jobNum` INTEGER NOT NULL, `taskNum` INTEGER NOT NULL, `priority` INTEGER NOT NULL, `useFifo` INTEGER NOT NULL, `comment` TEXT, `progressLevel` INTEGER NOT NULL, `progressMax` INTEGER NOT NULL, `thumbnailData` BLOB, `thumbnailUpdateTime` INTEGER NOT NULL, PRIMARY KEY(`id`))"
    ...
    const-string p0, "INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \'05137d4f629c59e4b0ee3e70048ba1d8\')"
...
.method public onValidateSchema(Landroidx/sqlite/db/SupportSQLiteDatabase;)Landroidx/room/RoomOpenHelper$ValidationResult;
    ...
    const-string/jumbo v3, "thumbnailUpdateTime"
