...
.method public createQuery()Ljava/lang/String;
    ...
    const-string p0, "INSERT OR ABORT INTO `bgCaptureRecord_table` (`id`,`mediaStoreUri`,`ts`,`expirationTime`,`clientId`,`sourceId`,`targetId`,`jobNum`,`taskNum`,`priority`,`useFifo`,`comment`,`progressLevel`,`progressMax`,`thumbWidth`,`thumbHeight`,`thumbnailPath`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
