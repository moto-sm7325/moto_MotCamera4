...
.field public static final enum UNKNOWN:Lcom/motorola/camera/background/common/RegisteredProcDef;
...
.method public static constructor <clinit>()V
    ...
    sget-object v9, Lcom/motorola/camera/background/common/ClientType;->CLIENT_BOTH:Lcom/motorola/camera/background/common/ClientType;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/motorola/camera/background/common/RegisteredProcDef;-><init>(Ljava/lang/String;IILjava/lang/String;Lcom/motorola/camera/background/common/ClientType;II)V

    sput-object v8, Lcom/motorola/camera/background/common/RegisteredProcDef;->UNKNOWN:Lcom/motorola/camera/background/common/RegisteredProcDef;
    ...
    sput-object v10, Lcom/motorola/camera/background/common/RegisteredProcDef;->PROCESS_MANAGER_SERVICE:Lcom/motorola/camera/background/common/RegisteredProcDef;

    .line 3
    new-instance v11, Lcom/motorola/camera/background/common/RegisteredProcDef;
    ...
    sput-object v11, Lcom/motorola/camera/background/common/RegisteredProcDef;->CAMERA_APP:Lcom/motorola/camera/background/common/RegisteredProcDef;

    .line 4
    new-instance v12, Lcom/motorola/camera/background/common/RegisteredProcDef;
    ...
    sput-object v12, Lcom/motorola/camera/background/common/RegisteredProcDef;->SAVE_IMAGE_SERVICE:Lcom/motorola/camera/background/common/RegisteredProcDef;

    .line 5
    new-instance v0, Lcom/motorola/camera/background/common/RegisteredProcDef;

    sget-object v18, Lcom/motorola/camera/background/common/ClientType;->COPROC:Lcom/motorola/camera/background/common/ClientType;

    const-string v14, "POST_PROCESS_SERVICE"

    const/4 v15, 0x4

    const/16 v16, 0x3

    const-string v17, "PostProcess_Service"
    ...
    invoke-direct/range {v13 .. v20}, Lcom/motorola/camera/background/common/RegisteredProcDef;-><init>(Ljava/lang/String;IILjava/lang/String;Lcom/motorola/camera/background/common/ClientType;II)V
    ...
    invoke-direct {v0, v1}, Lcom/motorola/camera/background/common/RegisteredProcDef$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    :cond_1
    sput-object v3, Lcom/motorola/camera/background/common/RegisteredProcDef;->map:Ljava/util/Map;

    return-void
.end method

.method public constructor <init>(Ljava/lang/String;IILjava/lang/String;Lcom/motorola/camera/background/common/ClientType;II)V
    .locals 0
