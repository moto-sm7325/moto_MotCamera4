...
.method public static final access$acquireClientIfNeeded(Lcom/motorola/camera/storage/MediaStoreClient;)Landroid/content/ContentProviderClient;
    .locals 1

    .line 1
    sget-object p0, Lcom/motorola/camera/storage/MediaStoreClient;->client:Landroid/content/ContentProviderClient;
    ...
    const-string v0, "getContext().contentResolver"
    ...
    .line 6
    :cond_0
    sput-object p0, Lcom/motorola/camera/storage/MediaStoreClient;->client:Landroid/content/ContentProviderClient;
...
.method public static final access$closeClient(Lcom/motorola/camera/storage/MediaStoreClient;)V
    .locals 0
...
.method public static final access$translateThrowable(Lcom/motorola/camera/storage/MediaStoreClient;Ljava/lang/Throwable;)Ljava/lang/Exception;
    .locals 4
    ...
    .line 3
    new-instance p0, Lcom/motorola/camera/storage/exception/DisconnectedException;

    const-string v0, "Provider disconnected"

    invoke-direct {p0, v0, p1}, Lcom/motorola/camera/storage/exception/DisconnectedException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    .line 5
    invoke-static {p0, v3, v1, v2}, Lkotlin/text/StringsKt__StringsJVMKt;->startsWith$default(Ljava/lang/String;Ljava/lang/String;ZI)Z
    ...
    .line 7
    new-instance v0, Lcom/motorola/camera/storage/exception/VolumeNotFoundException;

    invoke-direct {v0, p0, p1}, Lcom/motorola/camera/storage/exception/VolumeNotFoundException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    .line 9
    new-instance v0, Lcom/motorola/camera/storage/exception/AccessDeniedException;
    ...
    :cond_4
    invoke-direct {v0, p0, p1}, Lcom/motorola/camera/storage/exception/AccessDeniedException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static final deleteMediaItem(Landroid/net/Uri;)I
    ...
    invoke-direct {v0, p0, v1, v1, v2}, Lcom/motorola/camera/storage/MediaStoreClient$MediaStoreDelete;-><init>(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;I)V
...
.method public static final updateMediaItem(Landroid/net/Uri;Landroid/content/ContentValues;)I
    ...
    invoke-direct/range {v1 .. v6}, Lcom/motorola/camera/storage/MediaStoreClient$MediaStoreUpdate;-><init>(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;I)V
