...
.method public static convertNv21Image2Buffer(Landroid/media/Image;)[B
    .locals 12
    ...
    .line 12
    invoke-virtual {v4, v1, v11, v2}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;
    ...
    .line 13
    invoke-virtual {v4, v1, v5, v9}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;
    ...
    .line 16
    invoke-virtual {v8, v1, v9, v2}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;
    ...
    .line 20
    invoke-virtual {v8, v1, v9, p0}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;
    ...
    .line 22
    invoke-virtual {v6, v1, v2, v7}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;
...
.method public static getPreviewSizeBasedOnAspectRatio(Landroid/util/Size;)Landroid/util/Size;
    ...
    .line 3
    invoke-static {v0}, Lcom/motorola/camera/settings/SettingsManager;->getPreviewSizes(Ljava/lang/String;)[Landroid/util/Size;
...
.method public static getSelfiePreviewSize(Z)Landroid/util/Size;
    .locals 1

    const/4 v0, 0x0

    .line 1
    invoke-static {p0, v0}, Lcom/motorola/camera/panorama/PanoHelper;->getSelfiePreviewSize(Z[Landroid/util/Size;)Landroid/util/Size;
