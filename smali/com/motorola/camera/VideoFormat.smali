...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v4, v3, v3}, Landroid/util/Range;-><init>(Ljava/lang/Comparable;Ljava/lang/Comparable;)V

    .line 3
    invoke-direct {v0, v1, v4, v2}, Lcom/motorola/camera/VideoFormat;-><init>(Landroid/util/Size;Landroid/util/Range;Z)V
    ...
    sput-object v3, Lcom/motorola/camera/VideoFormat;->QHD:Landroid/util/Size;
    ...
    invoke-direct {v7, v6, v1}, Landroid/util/Size;-><init>(II)V

    sput-object v7, Lcom/motorola/camera/VideoFormat;->HD_18V9:Landroid/util/Size;
    ...
    invoke-direct {v1, v6, v8}, Landroid/util/Size;-><init>(II)V
    ...
    sput-object v6, Lcom/motorola/camera/VideoFormat;->FHD:Landroid/util/Size;

    .line 15
    new-instance v14, Landroid/util/Size;

    invoke-direct {v14, v12, v4}, Landroid/util/Size;-><init>(II)V
    ...
    invoke-direct {v4, v12, v14}, Landroid/util/Size;-><init>(II)V

    sput-object v4, Lcom/motorola/camera/VideoFormat;->FHD_19V9:Landroid/util/Size;
    ...
    invoke-direct {v15, v12, v2}, Landroid/util/Size;-><init>(II)V
    ...
    sput-object v2, Lcom/motorola/camera/VideoFormat;->FHD_20P5V9:Landroid/util/Size;
    ...
    sput-object v13, Lcom/motorola/camera/VideoFormat;->FHD_21V9:Landroid/util/Size;
    ...
    sput-object v3, Lcom/motorola/camera/VideoFormat;->CLI_FHD:Landroid/util/Size;
    ...
    sput-object v3, Lcom/motorola/camera/VideoFormat;->EQU_FHD:Landroid/util/Size;
    ...
    sput-object v11, Lcom/motorola/camera/VideoFormat;->EQU_4K:Landroid/util/Size;
    ...
    sput-object v9, Lcom/motorola/camera/VideoFormat;->UHD_4K_19V9:Landroid/util/Size;
    ...
    invoke-direct {v8, v12, v1}, Landroid/util/Size;-><init>(II)V

    sput-object v8, Lcom/motorola/camera/VideoFormat;->UHD_4K_19P5V9:Landroid/util/Size;
    ...
    invoke-direct {v1, v12, v7}, Landroid/util/Size;-><init>(II)V

    sput-object v1, Lcom/motorola/camera/VideoFormat;->UHD_4K_20V9:Landroid/util/Size;
    ...
    invoke-direct {v7, v12, v5}, Landroid/util/Size;-><init>(II)V

    sput-object v7, Lcom/motorola/camera/VideoFormat;->UHD_4K_20V9_2:Landroid/util/Size;
    ...
    invoke-direct {v5, v3, v12}, Landroid/util/Size;-><init>(II)V

    sput-object v5, Lcom/motorola/camera/VideoFormat;->UHD_4K_20P5V9:Landroid/util/Size;
    ...
    invoke-direct {v12, v3, v0}, Landroid/util/Size;-><init>(II)V

    sput-object v12, Lcom/motorola/camera/VideoFormat;->UHD_4K_21V9:Landroid/util/Size;
    ...
    invoke-direct {v0, v3, v13}, Landroid/util/Size;-><init>(II)V
    ...
    sput-object v13, Lcom/motorola/camera/VideoFormat;->UHD_4K_21V9_3:Landroid/util/Size;
    ...
    invoke-direct {v2, v3, v15}, Landroid/util/Size;-><init>(II)V
    ...
    invoke-direct {v14, v15, v4}, Landroid/util/Size;-><init>(II)V

    sput-object v14, Lcom/motorola/camera/VideoFormat;->UHD_6K_39V18:Landroid/util/Size;
    ...
    sput-object v4, Lcom/motorola/camera/VideoFormat;->UHD_6K_21V9:Landroid/util/Size;
    ...
    sput-object v6, Lcom/motorola/camera/VideoFormat;->UHD_8K:Landroid/util/Size;
    ...
    sput-object v5, Lcom/motorola/camera/VideoFormat;->UHD_8K_20V9:Landroid/util/Size;
    ...
    invoke-direct {v7, v15, v1}, Landroid/util/Size;-><init>(II)V

    sput-object v7, Lcom/motorola/camera/VideoFormat;->UHD_8K_20P5V9:Landroid/util/Size;
    ...
    new-array v15, v1, [Landroid/util/Size;
    ...
    sput-object v7, Lcom/motorola/camera/VideoFormat;->UHD_8K_SIZES:Ljava/util/List;
    ...
    sput-object v4, Lcom/motorola/camera/VideoFormat;->UHD_4K_SIZES:Ljava/util/List;
    ...
    new-array v14, v8, [Landroid/util/Size;
    ...
    sput-object v14, Lcom/motorola/camera/VideoFormat;->HD_SIZES:Ljava/util/List;

    new-array v15, v6, [Landroid/util/Size;
    ...
    sput-object v15, Lcom/motorola/camera/VideoFormat;->QHD_SIZES:Ljava/util/List;
    ...
    sput-object v8, Lcom/motorola/camera/VideoFormat;->VGA_SIZES:Ljava/util/List;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    :goto_1
    iput-boolean v2, p0, Lcom/motorola/camera/VideoFormat;->mIsHevcSupported:Z
