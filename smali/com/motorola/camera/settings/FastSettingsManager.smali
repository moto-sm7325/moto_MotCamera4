.class public Lcom/motorola/camera/settings/FastSettingsManager;
...
# instance fields
.field public mSettingsMap:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Lcom/motorola/camera/settings/SettingsManager$Key;",
...
.method public static constructor <clinit>()V
    ...
    const-string v2, "com.motorola.camera.mcf_override_config"

    invoke-direct {v0, v2, v1}, Lcom/motorola/camera/settings/SettingsManager$Key;-><init>(Ljava/lang/String;Ljava/lang/Class;)V

    sput-object v0, Lcom/motorola/camera/settings/FastSettingsManager;->MCF_OVERRIDE_CONFIG:Lcom/motorola/camera/settings/SettingsManager$Key;

    return-void
.end method

.method public constructor <init>(Lcom/motorola/camera/settings/FastSettingsManager$1;)V
    .locals 4
    ...
    invoke-static {p1, v0, v1, v2}, Lcom/motorola/camera/settings/SettingsFactory;->addSetting(Ljava/util/Map;Lcom/motorola/camera/settings/SettingsManager$Key;Ljava/lang/Object;I)V

    .line 4
    sget-object v0, Lcom/motorola/camera/settings/FastSettingsManager;->MODE_MENU_SHOW:Lcom/motorola/camera/settings/SettingsManager$Key;
    ...
    invoke-static {p1, v0, v1, v3, v2}, Lcom/motorola/camera/settings/SettingsFactory;->addSetting(Ljava/util/Map;Lcom/motorola/camera/settings/SettingsManager$Key;Ljava/lang/Object;ILjava/util/List;)V

    .line 6
    iput-object p1, p0, Lcom/motorola/camera/settings/FastSettingsManager;->mSettingsMap:Ljava/util/Map;
...
.method public static get(Lcom/motorola/camera/settings/SettingsManager$Key;)Lcom/motorola/camera/settings/Setting;
    ...
    .line 2
    iget-object v0, v0, Lcom/motorola/camera/settings/FastSettingsManager;->mSettingsMap:Ljava/util/Map;
