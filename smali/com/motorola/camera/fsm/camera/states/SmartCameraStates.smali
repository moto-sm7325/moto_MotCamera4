...
.method public configure(Lcom/motorola/camera/fsm/camera/CameraFsm$Builder;)V
    ...
    .line 7
    invoke-static {v0, v1}, Lcom/motorola/camera/fsm/camera/states/StateHelper;->getIdleTransitions(Lcom/motorola/camera/fsm/camera/Trigger$Event;Ljava/util/Collection;)Ljava/util/List;
    ...
    sget-object v4, Lcom/motorola/camera/fsm/camera/FsmContext$BundleType;->SMART_CAMERA:Lcom/motorola/camera/fsm/camera/FsmContext$BundleType;

    sget-object v5, Lcom/motorola/camera/analytics/AlwaysAwareData$Actions;->CAMERA_TIMEOUT:Lcom/motorola/camera/analytics/AlwaysAwareData$Actions;

    const-string v6, "RETURN_ACTION"

    invoke-direct {v3, v4, v6, v5}, Lcom/motorola/camera/fsm/camera/states/runnables/StoreSerializableBundleRunnable;-><init>(Lcom/motorola/camera/fsm/camera/FsmContext$BundleType;Ljava/lang/String;Ljava/io/Serializable;)V
    ...
    .line 18
    iput-object v3, v0, Lcom/motorola/camera/fsm/camera/CameraTransition$Builder;->mDoAfter:Lcom/motorola/camera/fsm/FsmRunnable;
    ...
    invoke-direct {v0, v4}, Lcom/motorola/camera/fsm/camera/states/runnables/ClearBundleRunnable;-><init>(Lcom/motorola/camera/fsm/camera/FsmContext$BundleType;)V
    ...
    new-instance v2, Lcom/motorola/camera/fsm/camera/states/runnables/StoreSerializableBundleRunnable;

    sget-object v3, Lcom/motorola/camera/analytics/AlwaysAwareData$Actions;->BACK_BUTTON:Lcom/motorola/camera/analytics/AlwaysAwareData$Actions;

    invoke-direct {v2, v4, v6, v3}, Lcom/motorola/camera/fsm/camera/states/runnables/StoreSerializableBundleRunnable;-><init>(Lcom/motorola/camera/fsm/camera/FsmContext$BundleType;Ljava/lang/String;Ljava/io/Serializable;)V

    .line 30
    invoke-static {p0, v1, v5, v2}, Lcom/motorola/camera/fsm/camera/states/StateHelper;->getIdleTransitions(Lcom/motorola/camera/fsm/camera/Trigger$Event;Ljava/util/Collection;Lcom/motorola/camera/fsm/camera/CameraRunnable;Lcom/motorola/camera/fsm/camera/CameraRunnable;)Ljava/util/List;
    ...
    .line 33
    invoke-static {p0, v1}, Lcom/motorola/camera/fsm/camera/states/StateHelper;->getIdleTransitions(Lcom/motorola/camera/fsm/camera/Trigger$Event;Ljava/util/Collection;)Ljava/util/List;
    ...
    sget-object v3, Lcom/motorola/camera/analytics/AlwaysAwareData$Actions;->TOUCH_OUTSIDE:Lcom/motorola/camera/analytics/AlwaysAwareData$Actions;
