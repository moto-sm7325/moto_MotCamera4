...
.field public mFocusMap:Ljava/util/TreeMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/TreeMap<",
            "Ljava/lang/String;",
...
.method public declared-synchronized isPassiveFocus()Z
    .locals 2
...
.method public declared-synchronized isPassiveFocusEnabledAndSuccessful()Z
    .locals 1
...
.method public onCaptureCompleted(Ljava/lang/String;Landroid/hardware/camera2/CaptureResult;Z)V
    .locals 10
    ...
    invoke-direct {p3, v0}, Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine$FocusHolder;-><init>(Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine$1;)V
    ...
    .line 17
    iget v4, p3, Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine$FocusHolder;->mLastAfMode:I
    ...
    .line 19
    iget v0, p3, Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine$FocusHolder;->mLastLensState:I
    ...
    .line 21
    :cond_7
    iget v0, p3, Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine$FocusHolder;->mLastAfState:I
    ...
    check-cast v4, Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine$AutoFocusStateListener;
    ...
    invoke-interface {v4, v8, v9}, Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine$AutoFocusStateListener;->onFocusModeChanged(II)V

    goto :goto_1

    .line 27
    :cond_9
    invoke-virtual {p0, p1, v5}, Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine;->setWaitingUnlock(Ljava/lang/String;Z)V
    ...
    .line 29
    iput v0, p3, Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine$FocusHolder;->mLastAfMode:I
    ...
    .line 31
    iput v0, p3, Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine$FocusHolder;->mLastAfState:I
    ...
    .line 33
    iput v0, p3, Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine$FocusHolder;->mLastLensState:I

    .line 34
    :cond_b
    iput-wide v6, p3, Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine$FocusHolder;->mFrameNumber:J
    ...
    .line 64
    invoke-interface {p1, p2}, Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine$AutoFocusStateListener;->onManualFocusCompleted(Landroid/hardware/camera2/CaptureResult;)V
    ...
    .line 67
    invoke-interface {p1, p2}, Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine$AutoFocusStateListener;->onManualFocusStarted(Landroid/hardware/camera2/CaptureResult;)V
...
.method public declared-synchronized restoreCacheFocusMode(Lcom/motorola/camera/fsm/camera/FsmContext;)V
    .locals 3
    ...
    .line 1
    :try_start_0
    iget v0, p0, Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine;->mCacheAfMode:I
    ...
    .line 3
    :cond_0
    invoke-virtual {p0, p1}, Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine;->updateCurrentFocusMode(Lcom/motorola/camera/fsm/camera/FsmContext;)V
...
.method public declared-synchronized setWaitingUnlock(Ljava/lang/String;Z)V
    .locals 1
    ...
    .line 2
    iput-boolean p2, p1, Lcom/motorola/camera/fsm/camera/subfsms/AutoFocusStateMachine$FocusHolder;->mWaitingUnlock:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized triggerAutoFocus(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    .locals 2
...
.method public declared-synchronized updateCurrentFocusMode(Lcom/motorola/camera/fsm/camera/FsmContext;)V
    .locals 3
