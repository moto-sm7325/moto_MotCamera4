...
# instance fields
.field public m3aMap:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
...
.field public final mCancelSet:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set<",
            "Lcom/motorola/camera/fsm/camera/subfsms/McfStateMachine$McfCancelInterface;",
...
.method public constructor <init>()V
    ...
    .line 3
    iput v0, p0, Lcom/motorola/camera/fsm/camera/subfsms/McfStateMachine;->mLastLux:F
...
# virtual methods
.method public canSafelyChangeStreamSetup()Z
    .locals 6
    ...
    .line 3
    iget-object v3, v3, Lcom/motorola/camera/fsm/camera/subfsms/McfStateMachine$McfJobHolder;->mMcfRequestHolderMap:Ljava/util/Map;
    ...
    .line 5
    iget-object v4, v4, Lcom/motorola/camera/fsm/camera/subfsms/McfStateMachine$McfRequestHolder;->mProgressList:Ljava/util/List;
...
.method public cancelAllJobs(Z)V
    ...
    invoke-interface {v1, p1}, Lcom/motorola/camera/fsm/camera/subfsms/McfStateMachine$McfCancelInterface;->cancelAllJobs(Z)V
...
.method public isFrameCollectionDone()Z
    .locals 6
...
.method public final notifyBgProcessing(Lcom/motorola/camera/mcf/Mcf$SceneMode;)V
    .locals 5
    ...
    check-cast v2, Lcom/motorola/camera/fsm/camera/subfsms/McfStateMachine$McfRequestHolder;

    .line 5
    sget-object v3, Lcom/motorola/camera/mcf/Mcf$InstanceType;->HDR:Lcom/motorola/camera/mcf/Mcf$InstanceType;

    iget-object v4, v2, Lcom/motorola/camera/fsm/camera/subfsms/McfStateMachine$McfRequestHolder;->mInstanceType:Lcom/motorola/camera/mcf/Mcf$InstanceType;

    if-eq v3, v4, :cond_2

    sget-object v3, Lcom/motorola/camera/mcf/Mcf$InstanceType;->LOW_LIGHT_FRAME_STACK:Lcom/motorola/camera/mcf/Mcf$InstanceType;
    ...
    sget-object v3, Lcom/motorola/camera/mcf/Mcf$InstanceType;->SUPER_RESOLUTION:Lcom/motorola/camera/mcf/Mcf$InstanceType;

    if-eq v3, v4, :cond_2

    sget-object v3, Lcom/motorola/camera/mcf/Mcf$InstanceType;->ZSL_DEPTH_RENDER:Lcom/motorola/camera/mcf/Mcf$InstanceType;

    if-ne v3, v4, :cond_1

    .line 6
    :cond_2
    iget-object v2, v2, Lcom/motorola/camera/fsm/camera/subfsms/McfStateMachine$McfRequestHolder;->mProgressList:Ljava/util/List;

    .line 7
    sget-object v3, Lcom/motorola/camera/mcf/Mcf$ProgressType;->STATE_MACHINE_STARTED:Lcom/motorola/camera/mcf/Mcf$ProgressType;
    ...
    sget-object v3, Lcom/motorola/camera/mcf/Mcf$ProgressType;->STATE_MACHINE_BG_STARTED:Lcom/motorola/camera/mcf/Mcf$ProgressType;
    ...
    sget-object v3, Lcom/motorola/camera/mcf/Mcf$ProgressType;->STATE_MACHINE_STOPPED:Lcom/motorola/camera/mcf/Mcf$ProgressType;
...
.method public final notifyFrameCollection()V
    ...
    .line 3
    iget-object v2, v2, Lcom/motorola/camera/fsm/camera/subfsms/McfStateMachine$McfJobHolder;->mMcfRequestHolderMap:Ljava/util/Map;
    ...
    .line 6
    :cond_2
    iget-object v3, v3, Lcom/motorola/camera/fsm/camera/subfsms/McfStateMachine$McfRequestHolder;->mProgressList:Ljava/util/List;
...
.method public onCaptureCompleted(Ljava/lang/String;Landroid/hardware/camera2/CaptureResult;)V
    ...
    iput p1, p0, Lcom/motorola/camera/fsm/camera/subfsms/McfStateMachine;->mLastLux:F
...
.method public onJobCompleted(I)V
    ...
    .line 7
    invoke-virtual {v1}, Lcom/motorola/camera/fsm/camera/subfsms/McfStateMachine$McfStateAdapter;->onJobsCancelled()V
...
.method public onPostViewFrame(Lcom/motorola/camera/fsm/camera/record/SequenceIdentifier;Lcom/motorola/camera/mcf/McfAuxFrameData;Landroid/os/Bundle;)V
    .locals 1
