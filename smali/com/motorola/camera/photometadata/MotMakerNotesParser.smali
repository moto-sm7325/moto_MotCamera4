.class public Lcom/motorola/camera/photometadata/MotMakerNotesParser;
...
.field public mMakerNotesMap:Landroid/util/SparseArray;
...
.method public static appendAppInfoToMetadata(Ljava/lang/String;Landroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    invoke-interface {v2, v5}, Ljava/util/Set;->removeIf(Ljava/util/function/Predicate;)Z
...
.method public static appendInfo(Ljava/lang/String;Lcom/motorola/camera/photometadata/MotMakerNotesParser$Tags;Lcom/motorola/camera/shared/PackageUtility;Ljava/io/OutputStream;)V
    ...
    .line 6
    iget-object v0, p2, Lcom/motorola/camera/photometadata/ByteOrderedDataOutputStream;->mOutputStream:Ljava/io/OutputStream;
    ...
    .line 10
    iget-object p3, p2, Lcom/motorola/camera/photometadata/ByteOrderedDataOutputStream;->mOutputStream:Ljava/io/OutputStream;
    ...
    .line 12
    iget-object p1, p2, Lcom/motorola/camera/photometadata/ByteOrderedDataOutputStream;->mOutputStream:Ljava/io/OutputStream;
...
# virtual methods
.method public addEntryMarkerData([B)V
    .locals 22
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v11, v0, Lcom/motorola/camera/photometadata/MotMakerNotesParser;->mByteOrder:Ljava/nio/ByteOrder;

    invoke-direct {v7, v10, v11}, Lcom/motorola/camera/photometadata/ByteOrderedDataOutputStream;-><init>(Ljava/io/OutputStream;Ljava/nio/ByteOrder;)V
    ...
    .line 16
    iget-object v13, v7, Lcom/motorola/camera/photometadata/ByteOrderedDataOutputStream;->mByteOrder:Ljava/nio/ByteOrder;
    ...
    .line 17
    iget-object v13, v7, Lcom/motorola/camera/photometadata/ByteOrderedDataOutputStream;->mOutputStream:Ljava/io/OutputStream;
    ...
    invoke-virtual {v13, v2}, Ljava/io/OutputStream;->write(I)V

    .line 18
    iget-object v2, v7, Lcom/motorola/camera/photometadata/ByteOrderedDataOutputStream;->mOutputStream:Ljava/io/OutputStream;

    ushr-long v8, v11, v21
    ...
    invoke-direct {v4, v6, v7}, Lcom/motorola/camera/photometadata/ByteOrderedDataOutputStream;-><init>(Ljava/io/OutputStream;Ljava/nio/ByteOrder;)V
    ...
    invoke-virtual {v4, v6}, Lcom/motorola/camera/photometadata/ByteOrderedDataOutputStream;->writeInt(I)V
    ...
    invoke-virtual {v4, v6}, Lcom/motorola/camera/photometadata/ByteOrderedDataOutputStream;->writeShort(S)V
    ...
    :goto_7
    const-string v6, "Unknown type, update the parser"
    ...
    .line 46
    :goto_8
    new-instance v2, Lcom/motorola/camera/photometadata/MotMakerNotesParser$MakerNoteContainer;

    move v3, v14

    const/4 v6, 0x0

    invoke-direct {v2, v3, v5, v4, v6}, Lcom/motorola/camera/photometadata/MotMakerNotesParser$MakerNoteContainer;-><init>(II[BLcom/motorola/camera/photometadata/MotMakerNotesParser$1;)V
...
.method public get(Lcom/motorola/camera/photometadata/MotMakerNotesParser$Tags;)Ljava/lang/String;
    .locals 7
...
.method public parse([B)V
    ...
    invoke-direct {v3, v2, v5, v4, v6}, Ljava/lang/String;-><init>([BIILjava/lang/String;)V
    ...
    invoke-direct {v8, v6, v7, v10, v9}, Lcom/motorola/camera/photometadata/MotMakerNotesParser$MakerNoteContainer;-><init>(II[BLcom/motorola/camera/photometadata/MotMakerNotesParser$1;)V
