...
.method public consume(Lcom/google/android/exoplayer2/util/ParsableByteArray;)V
    ...
    .line 27
    iget-object v15, v0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader;->pps:Lcom/google/android/exoplayer2/extractor/ts/NalUnitTargetBuffer;

    iget-object v13, v15, Lcom/google/android/exoplayer2/extractor/ts/NalUnitTargetBuffer;->nalData:[B

    iget v15, v15, Lcom/google/android/exoplayer2/extractor/ts/NalUnitTargetBuffer;->nalLength:I

    invoke-static {v13, v14, v15}, Lcom/google/android/exoplayer2/util/NalUnitUtil;->parsePpsNalUnit([BII)Lcom/google/android/exoplayer2/util/NalUnitUtil$PpsData;
    ...
    .line 29
    invoke-static {v14, v15, v3}, Lcom/google/android/exoplayer2/util/CodecSpecificDataUtil;->buildAvcCodecString(III)Ljava/lang/String;
    ...
    .line 38
    iget v3, v2, Lcom/google/android/exoplayer2/util/NalUnitUtil$SpsData;->pixelWidthAspectRatio:F
    ...
    iget v3, v13, Lcom/google/android/exoplayer2/util/NalUnitUtil$PpsData;->picParameterSetId:I
    ...
    invoke-static {v3, v14, v2}, Lcom/google/android/exoplayer2/util/NalUnitUtil;->parsePpsNalUnit([BII)Lcom/google/android/exoplayer2/util/NalUnitUtil$PpsData;
    ...
    invoke-static {v10, v11, v3, v2}, Lcom/google/android/exoplayer2/extractor/CeaUtil;->consume(JLcom/google/android/exoplayer2/util/ParsableByteArray;[Lcom/google/android/exoplayer2/extractor/TrackOutput;)V
...
.method public final nalUnitData([BII)V
    ...
    .line 12
    iget-object v2, v0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->bitArray:Lcom/google/android/exoplayer2/util/ParsableBitArray;

    iget-object v3, v0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->buffer:[B

    const/4 v4, 0x0

    invoke-virtual {v2, v3, v4, v1}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->reset([BII)V

    .line 13
    iget-object v1, v0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->bitArray:Lcom/google/android/exoplayer2/util/ParsableBitArray;

    const/16 v2, 0x8

    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->canReadBits(I)Z
    ...
    invoke-virtual {v2}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->canReadExpGolombCodedNum()Z
    ...
    .line 19
    invoke-virtual {v2}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->readExpGolombCodeNum()I
    ...
    .line 28
    :cond_7
    iget-object v5, v0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->bitArray:Lcom/google/android/exoplayer2/util/ParsableBitArray;

    invoke-virtual {v5}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->canReadExpGolombCodedNum()Z
    ...
    .line 30
    invoke-virtual {v5}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->readExpGolombCodeNum()I
    ...
    .line 36
    iget-object v10, v0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->bitArray:Lcom/google/android/exoplayer2/util/ParsableBitArray;

    invoke-virtual {v10, v7}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->canReadBits(I)Z
    ...
    invoke-virtual {v10, v7}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->skipBits(I)V

    .line 38
    :cond_b
    iget-object v7, v0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->bitArray:Lcom/google/android/exoplayer2/util/ParsableBitArray;

    iget v10, v9, Lcom/google/android/exoplayer2/util/NalUnitUtil$SpsData;->frameNumLength:I

    invoke-virtual {v7, v10}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->canReadBits(I)Z
    ...
    invoke-virtual {v7, v10}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->readBits(I)I
    ...
    invoke-virtual {v10, v6}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->canReadBits(I)Z
    ...
    .line 43
    iget-object v11, v0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->bitArray:Lcom/google/android/exoplayer2/util/ParsableBitArray;

    invoke-virtual {v11, v6}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->canReadBits(I)Z
    ...
    .line 46
    iget-object v13, v0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->bitArray:Lcom/google/android/exoplayer2/util/ParsableBitArray;

    invoke-virtual {v13}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->canReadExpGolombCodedNum()Z
    ...
    .line 48
    invoke-virtual {v13}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->readExpGolombCodeNum()I
    ...
    .line 50
    iget-object v14, v0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->bitArray:Lcom/google/android/exoplayer2/util/ParsableBitArray;

    iget v15, v9, Lcom/google/android/exoplayer2/util/NalUnitUtil$SpsData;->picOrderCntLsbLength:I

    invoke-virtual {v14, v15}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->canReadBits(I)Z
    ...
    .line 53
    iget-object v8, v0, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader;->bitArray:Lcom/google/android/exoplayer2/util/ParsableBitArray;

    invoke-virtual {v8}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->canReadExpGolombCodedNum()Z
    ...
    invoke-virtual {v8}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->readSignedExpGolombCodedInt()I
    ...
    invoke-virtual {v14}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->canReadExpGolombCodedNum()Z
    ...
    invoke-virtual {v14}, Lcom/google/android/exoplayer2/util/ParsableBitArray;->readSignedExpGolombCodedInt()I
    ...
    .line 70
    iput-boolean v3, v6, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader$SliceHeaderData;->idrPicFlag:Z
    ...
    .line 74
    iput v4, v6, Lcom/google/android/exoplayer2/extractor/ts/H264Reader$SampleReader$SliceHeaderData;->deltaPicOrderCnt0:I
