...
.method public onCreateExpandedStateChangeAnimation(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    .line 93
    invoke-static {v9, v8, v14, v14}, Landroidx/cardview/R$color;->dist(FFFF)F

    move-result v15

    .line 94
    invoke-static {v9, v8, v6, v14}, Landroidx/cardview/R$color;->dist(FFFF)F

    move-result v21

    .line 95
    invoke-static {v9, v8, v6, v7}, Landroidx/cardview/R$color;->dist(FFFF)F

    move-result v6

    .line 96
    invoke-static {v9, v8, v14, v7}, Landroidx/cardview/R$color;->dist(FFFF)F
    ...
    .line 157
    invoke-static {v0, v1}, Landroidx/appcompat/R$layout;->playTogether(Landroid/animation/AnimatorSet;Ljava/util/List;)V
