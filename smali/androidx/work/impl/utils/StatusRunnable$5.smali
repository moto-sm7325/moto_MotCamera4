...
.method public runInternal()Ljava/lang/Object;
    ...
    .line 6
    iget-object v3, p0, Landroidx/work/WorkQuery;->mStates:Ljava/util/List;
    ...
    .line 16
    :cond_1
    iget-object v3, p0, Landroidx/work/WorkQuery;->mIds:Ljava/util/List;
    ...
    .line 26
    :cond_3
    iget-object v3, p0, Landroidx/work/WorkQuery;->mTags:Ljava/util/List;
    ...
    invoke-static {v1, p0, v2, v3}, Landroidx/room/util/DBUtil;->query(Landroidx/room/RoomDatabase;Landroidx/sqlite/db/SupportSQLiteQuery;ZLandroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    .line 86
    sget-object p0, Landroidx/work/impl/model/WorkSpec;->WORK_INFO_MAPPER:Landroidx/arch/core/util/Function;

    check-cast p0, Landroidx/work/impl/model/WorkSpec$1;
